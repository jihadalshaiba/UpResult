...
<head>
    ...
    <title>الجامعة اليمنية الاردنية| لوحة تحكم</title>
...
<body class="top-navbar-fixed">
    <div class="main-wrapper">
        <nav class="navbar top-navbar bg-white" dir>
            <div class="container-fluid">
                <div class="row">
                    <div class="navbar-header no-padding">
                        <a class="navbar-brand" target="a_blank" href="#">
                            <img src="assets/images/logo.png" class="d-none" style="Width: 165px;height:40px;">
                        </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse-1">
                        ...
                        <!-- /.nav navbar-nav -->
                        <ul class="nav navbar-nav navbar-left" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            <li>
                                <a href="logout.php" class="color-dark text-center"><i class="fa fa-sign-out"></i> تسجيل خروج</a>
                            </li>
                            <li>
                                <a href="javascript:window_close();"> اغلاق النظام</a>
                            </li>
